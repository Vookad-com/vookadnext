...
import Logo from '@/public/assets/vookad.svg'
          ...
          <div className={styles.connect}>
            ...
            <ul className="grid grid-cols-4 gap-3 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="text-[#fff] bg-[var(--orange)]"
                >
                ...
                <li>
                <a href="https://www.instagram.com/wevookad/" rel="noreferrer" target="_blank" className="text-[#fff] bg-[var(--orange)]">
                ...
                <li>
                <a href="https://github.com/Vookad-com" rel="noreferrer" target="_blank" className="text-[#fff] bg-[var(--orange)]">
