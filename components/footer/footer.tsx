        ...
        <div className={`${styles.sitemap} grid md:grid-cols-5 gap-2 grid-cols-2`}>
          ...
          <div className={styles.connect}>
            ...
            <ul className="grid grid-cols-4 gap-3 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <li>
                <a href="https://www.instagram.com/wevookad/" rel="noreferrer" target="_blank" className="text-[#fff] bg-pink">
                ...
                <li>
                <a href="https://github.com/Vookad-com" rel="noreferrer" target="_blank" className="text-[#fff] bg-pink">
